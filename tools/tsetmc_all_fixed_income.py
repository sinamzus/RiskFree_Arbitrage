...
def is_fixed_income(name: str) -> bool:
    ...
    for ex in EXCLUDE:
        if ex in name:
            return False
    # اگر صراحتاً درآمد ثابت دارد
    if "درآمد" in name or "ثابت" in name or "پايدار" in name:
        return True
    # اگر کلمه منفی ندارد احتمالاً درآمد ثابت است — نگه می‌داریم برای بررسی
    return True
...
# اسامی صندوق‌های شناخته‌شده
keywords += [
    "امين يكم", "تصميم", "كمند", "كيان", "ماني", "پارند", "اعتماد",
    "افران", "لبخند", "آفاق", "گنجين", "خاتم", "فردا", "ياقوت",
    "فيروزا", "هماي", "صايند", "كارآمد", "كارما", "پاسارگاد",
    "پايش", "آسود", "اطمينان", "اونيكس", "ترنج ثابت", "اكسيژن", "دامون",
    "آوند", "شميم", "آسا درآمد", "آسان درآمد", "ريكا", "آذين",
    "نگين ثابت", "آرمان ثابت", "سپهر ثابت", "سينا درآمد",
]
